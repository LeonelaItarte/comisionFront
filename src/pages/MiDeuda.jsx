...
export default function MiDeuda() {

  const [pagina, setPagina] = useState(1);
  const hasNext = pagina < Math.ceil(25 / 10);
  ...
  const columns = useMemo(
    () => [
        ...
        },
        {
            ...
            accessor: 'FechaDeAcreditacion',
        },
        {
            Header: 'Canal de Cobro',
            accessor: 'canalDeCobro',
        },
        {
